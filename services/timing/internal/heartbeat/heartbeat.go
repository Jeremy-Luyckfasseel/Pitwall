// Package heartbeat is Timing's facade over the shared 1 s liveness emitter in
// libs/go-pitwall/heartbeat (Story 2.1). The emit loop + liveness touch-file mechanics
// live once in the library; this re-exports them so Timing's main keeps constructing
